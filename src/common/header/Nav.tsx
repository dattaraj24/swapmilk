  ...
  return (
    <nav className="mainmenu-nav">
      <ul className="mainmenu">
        <li>
          <a href="https://milkshakeswap.finance/" target="_parent">Home</a>
        </li>
        ...
        <li>
          <a href="https://milkshakeswap.finance/farm" target="_parent">Milking</a>
        </li>
        <li>
          <a href="https://milkshakeswap.finance/pool" target="_parent">Flavour Pool</a> 
        </li>
        <li>
          <a href="https://milkshakeswap.finance/stake" target="_parent">Staking</a>
        </li>
        <li>
          {account ? (
