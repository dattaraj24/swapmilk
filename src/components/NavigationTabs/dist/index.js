...
function SwapPoolTabs(_a) {
    ...
    return (react_1["default"].createElement(Tabs, { style: { marginBottom: '20px' } },
        ...
        react_1["default"].createElement(StyledAbsoluteLink, { id: "pool-nav-link", target: "_parent", href: "https://www.binance.org/en/panama" }, "Bridge")));
}
...
exports.Nav = function (_a) {
    ...
    return (react_1["default"].createElement(uikit_1.ButtonMenu, { activeIndex: activeIndex, size: "sm", variant: "subtle" },
        ...
        react_1["default"].createElement(uikit_1.ButtonMenuItem, { id: "pool-nav-link", as: "a", href: "https://www.binance.org/en/panama", target: "_parent", rel: "noreferrer noopener" }, "Bridge")));
};
